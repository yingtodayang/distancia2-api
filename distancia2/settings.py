...
MODEL_YOLO = env('MODEL_YOLO')
MODEL_WEIGHTS_PATH_V3 = env('MODEL_WEIGHTS_PATH_V3')
MODEL_CONFIG_PATH_V3 = env('MODEL_CONFIG_PATH_V3')
MODEL_WEIGHTS_PATH_V4 = env('MODEL_WEIGHTS_PATH_V4')
MODEL_CONFIG_PATH_V4 = env('MODEL_CONFIG_PATH_V4')
